...
public class Utilerias
    {        
        ...
        /// </summary>
        /// <param name="cadena">donde se buscarán los dígitos</param>
        /// <returns>verdadero si encontró aunque sea uno solo de los 10 dígitos, falso si no encontro ninguno</returns>
        public static bool ContieneDigitos(string cadena)
        {
            ...
            while (i < cadena.Length && res == false)
            {
                ...
                if (digitos.IndexOf(digito) > -1) //en cuanto esta el caracter entre los dígitos devuelve verdadero
                {
                        res = true;
                }
                i++;
