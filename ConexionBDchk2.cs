  ...
  public class ConexionBDchkDos
    {
        ...
        public string DameCadenaConexion
        {
			...
			set {
			   this.strConBDC = value;
			}
        }


        public ConexionBDchkDos(string cadena)
        {
            this.TipoConexion = TipoConexion.Trim();            
            this.strConBDC = cadena.Trim(); //ConfigurationManager.AppSettings["ConnectionString"].ToString();
